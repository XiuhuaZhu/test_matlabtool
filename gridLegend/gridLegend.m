...
% xh % recover the plot information
set(gca,'position',opos)

outpos=get(gca,'outerposition'); 

% xh % adjust the position of the legend
hh=legend; pos=get(hh,'position');
...
set(hh, 'box','off',...
    'color','none',...
    'position',[pos(1)-0.02 adj pos(3) pos(4)]);
